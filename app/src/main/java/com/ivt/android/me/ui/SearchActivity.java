...
public class SearchActivity extends BaseActivity implements View.OnClickListener {
    ...
    private String str = "",info1="",info2="";
        ...
        public void run() {
            while (running) {
                ...
                try {
                    ...
                    System.out.println("服务端数据======="+(str = br.readLine()));
...
//                }
    ...
    //Toast方法
    private void displayToast(String s) { Toast.makeText(this, s, Toast.LENGTH_SHORT).show(); }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    System.out.println("返回成功==="+msg.obj);
                    if (info1 != null && !info1.equals("")){
                        info2+=info1+"\n";
                    }
                    tv.setText(info2);//把读到的内容更新到UI
                    break;
                case 0:
                    displayToast("连接成功");
                    break;
